...
<div id="container">
    <form action="user_board_update_ok" enctype="multipart/form-data" method="post" id="frm">
        <div class="cont_div">
            <input type="hidden" name="back_end_list_no" value="${bv.back_end_list_no}">
            <span><input name="back_end_list_id" value="${user_id}" disabled></span>
            <br>
            <br>
            <input type="text" placeholder="제 목" name="back_end_list_title" id="back_end_list_title" value="${bv.back_end_list_title}">
            <br>
            <textarea rows="20" cols="123" id="back_end_list_cont" name="back_end_list_cont">${bv.back_end_list_cont}</textarea>
        </div>
        ...
        <div>
            ...
            <br>
            <br>
            <input type="button" id="save" value="수 정">
        </div>
    </form>
</div>
